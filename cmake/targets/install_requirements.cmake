...
if     (VERSION_OF_NODEJS STREQUAL "[none]")
    set(PACKAGE_OF_NODEJS "")
elseif (VERSION_OF_NODEJS STREQUAL "")
    set(PACKAGE_OF_NODEJS "conda-forge::nodejs")
else()
    set(PACKAGE_OF_NODEJS "conda-forge::nodejs=${VERSION_OF_NODEJS}")
endif()
remove_cmake_message_indent()
message("")
execute_process(
...
set(REQUIREMENTS_TXT_PATH "${PROJ_OUT_REPO_DIR}/docs/requirements-doc.txt")
